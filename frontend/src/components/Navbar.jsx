    ...
    <nav className="bg-white shadow-md sticky top-0 z-50">
      <div className="max-w-6xl mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <Link to="/menu" className="text-gray-600 hover:text-primary font-medium">
            Menu
          </Link>
          {user && (
      ...
      {menuOpen && (
        <div className="md:hidden bg-white border-t px-4 py-3 flex flex-col gap-3">
          <Link to="/" onClick={() => setMenuOpen(false)}
            className="text-gray-600 hover:text-primary font-medium py-2 border-b">
            Home
          </Link>
          ...
          {user ? (
            ...
            <div className="flex gap-2">
              <Link to="/login" onClick={() => setMenuOpen(false)}
                className="border border-primary text-primary px-4 py-2 rounded-lg flex-1 text-center">
                Login
              </Link>
              <Link to="/register" onClick={() => setMenuOpen(false)}
                className="bg-primary text-white px-4 py-2 rounded-lg flex-1 text-center">
                Register
              </Link>
            </div>
          )}
